 ...
 */
class TaalString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaalString';
    ...
    public const TAAL_NEDERLANDS = 'NEDERLANDS';
    public const TAAL_NEDERLANDS_FORMEEL = 'NEDERLANDS_FORMEEL';
    public const TAAL_NEDERLANDS_FORMEEL_GENERATED = 'NEDERLANDS_FORMEEL_GENERATED';
    public const TAAL_NEDERLANDS_INFORMEEL = 'NEDERLANDS_INFORMEEL';
    public const TAAL_NEDERLANDS_INFORMEEL_GENERATED = 'NEDERLANDS_INFORMEEL_GENERATED';
    public const TAAL_NEDERLANDS_U = 'NEDERLANDS_U';
    public const TAAL_NEDERLANDS_JE = 'NEDERLANDS_JE';
    public const TAAL_FRANS = 'FRANS';
    public const TAAL_DUITS = 'DUITS';
    public const TAAL_ENGELS = 'ENGELS';
    public const TAAL_ENGELS_GENERATED = 'ENGELS_GENERATED';
     ...
     * @return string[]
     */
    public function getTaalAllowableValues()
    {
        return [
            self::TAAL_NEDERLANDS,
            self::TAAL_NEDERLANDS_FORMEEL,
            self::TAAL_NEDERLANDS_FORMEEL_GENERATED,
            self::TAAL_NEDERLANDS_INFORMEEL,
            self::TAAL_NEDERLANDS_INFORMEEL_GENERATED,
            self::TAAL_NEDERLANDS_U,
            self::TAAL_NEDERLANDS_JE,
            self::TAAL_FRANS,
            self::TAAL_DUITS,
            self::TAAL_ENGELS,
            self::TAAL_ENGELS_GENERATED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vertaling', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTaalAllowableValues();
        if (!is_null($this->container['taal']) && !in_array($this->container['taal'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'taal', must be one of '%s'",
                $this->container['taal'],
    ...
    public function setTaal($taal)
    {
        ...
        $allowedValues = $this->getTaalAllowableValues();
        if (!in_array($taal, $allowedValues, true)) {
     ...
     * @return string[]|null
     */
    public function getVertaling()
    {
        return $this->container['vertaling'];
    }

    /**
     * Sets vertaling
     *
     * @param string[]|null $vertaling vertaling
     *
     * @return self
     */
    public function setVertaling($vertaling)
    {
        if (is_null($vertaling)) {
            throw new \InvalidArgumentException('non-nullable vertaling cannot be null');
        }
        $this->container['vertaling'] = $vertaling;
