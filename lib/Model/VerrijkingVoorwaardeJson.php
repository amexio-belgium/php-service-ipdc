...
/**
 * VerrijkingVoorwaardeJson Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerrijkingVoorwaardeJson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerrijkingVoorwaardeJson';
    ...
    protected static $openAPITypes = [
        ...
        'naam' => 'object',
        'beschrijving' => 'object',
        'options_policy' => 'string',
        'opties' => '\OpenAPI\Client\Model\VerrijkingVoorwaardeOptieJson[]'
    ];
    ...
    protected static $setters = [
        ...
        'options_policy' => 'setOptionsPolicy',
        'opties' => 'setOpties'
    ];
    ...
    protected static $getters = [
        ...
        'options_policy' => 'getOptionsPolicy',
        'opties' => 'getOpties'
    ];
    ...
    public const OPTIONS_POLICY__STATIC = 'STATIC';
    public const OPTIONS_POLICY_DYNAMIC = 'DYNAMIC';
     ...
     * @return string[]
     */
    public function getOptionsPolicyAllowableValues()
    {
        return [
            self::OPTIONS_POLICY__STATIC,
            self::OPTIONS_POLICY_DYNAMIC,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('options_policy', $data ?? [], null);
        $this->setIfExists('opties', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getOptionsPolicyAllowableValues();
        if (!is_null($this->container['options_policy']) && !in_array($this->container['options_policy'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'options_policy', must be one of '%s'",
                $this->container['options_policy'],
     ...
     * @return string|null
     */
    public function getOptionsPolicy()
    {
        return $this->container['options_policy'];
    }

    /**
     * Sets options_policy
     *
     * @param string|null $options_policy options_policy
     *
     * @return self
     */
    public function setOptionsPolicy($options_policy)
    {
        if (is_null($options_policy)) {
            throw new \InvalidArgumentException('non-nullable options_policy cannot be null');
        }
        $allowedValues = $this->getOptionsPolicyAllowableValues();
        if (!in_array($options_policy, $allowedValues, true)) {
        ...
        $this->container['options_policy'] = $options_policy;
     ...
     * Gets opties
     *
     * @return \OpenAPI\Client\Model\VerrijkingVoorwaardeOptieJson[]|null
     */
    public function getOpties()
    {
        return $this->container['opties'];
    }

    /**
     * Sets opties
     *
     * @param \OpenAPI\Client\Model\VerrijkingVoorwaardeOptieJson[]|null $opties opties
     *
     * @return self
     */
    public function setOpties($opties)
    {
        if (is_null($opties)) {
            throw new \InvalidArgumentException('non-nullable opties cannot be null');
        }
        $this->container['opties'] = $opties;
