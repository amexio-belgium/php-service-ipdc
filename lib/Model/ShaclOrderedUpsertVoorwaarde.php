...
/**
 * ShaclOrderedUpsertVoorwaarde Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShaclOrderedUpsertVoorwaarde implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShaclOrderedUpsertVoorwaarde';
    ...
    protected static $openAPITypes = [
        ...
        'bewijs' => '\OpenAPI\Client\Model\Bewijs',
        'order' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bewijs', $data ?? [], null);
    ...
    */
     ...
     * Sets naam
     *
     * @param \OpenAPI\Client\Model\InputVertalingen|null $naam naam
     *
     * @return self
     */
     ...
     * Sets beschrijving
     *
     * @param \OpenAPI\Client\Model\InputVertalingen|null $beschrijving beschrijving
     *
     * @return self
     */
     ...
     * Gets bewijs
     *
     * @return \OpenAPI\Client\Model\Bewijs|null
     */
    public function getBewijs()
    {
        return $this->container['bewijs'];
    }

    /**
     * Sets bewijs
     *
     * @param \OpenAPI\Client\Model\Bewijs|null $bewijs bewijs
     *
     * @return self
     */
    public function setBewijs($bewijs)
    {
        if (is_null($bewijs)) {
            throw new \InvalidArgumentException('non-nullable bewijs cannot be null');
        }
        $this->container['bewijs'] = $bewijs;
