...
/**
 * RateLimitConfigurationJson Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RateLimitConfigurationJson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RateLimitConfigurationJson';
    ...
    protected static $setters = [
        'token_allowance' => 'setTokenAllowance',
        'refill_interval' => 'setRefillInterval',
    ...
    protected static $getters = [
        'token_allowance' => 'getTokenAllowance',
        'refill_interval' => 'getRefillInterval',
    ...
    {
        $this->setIfExists('token_allowance', $data ?? [], null);
        $this->setIfExists('refill_interval', $data ?? [], null);
        $this->setIfExists('bucket_size', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets token_allowance
     *
     * @return int|null
     */
    public function getTokenAllowance()
    {
        return $this->container['token_allowance'];
    }

    /**
     * Sets token_allowance
     *
     * @param int|null $token_allowance token_allowance
     *
     * @return self
     */
    public function setTokenAllowance($token_allowance)
    {
        if (is_null($token_allowance)) {
            throw new \InvalidArgumentException('non-nullable token_allowance cannot be null');
        }
        $this->container['token_allowance'] = $token_allowance;

        return $this;
    }

    /**
     * Gets refill_interval
     *
     * @return string|null
     */
    public function getRefillInterval()
    {
        return $this->container['refill_interval'];
    }

    /**
     * Sets refill_interval
     *
     * @param string|null $refill_interval refill_interval
     *
     * @return self
     */
    public function setRefillInterval($refill_interval)
    {
        if (is_null($refill_interval)) {
            throw new \InvalidArgumentException('non-nullable refill_interval cannot be null');
        }
        $this->container['refill_interval'] = $refill_interval;
     ...
     * Sets bucket_size
     *
     * @param string|null $bucket_size bucket_size
     *
     * @return self
     */
    public function setBucketSize($bucket_size)
    {
        if (is_null($bucket_size)) {
            throw new \InvalidArgumentException('non-nullable bucket_size cannot be null');
        }
