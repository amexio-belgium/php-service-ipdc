...
/**
 * VerrijkingUsage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerrijkingUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerrijkingUsage';
    ...
    {
        $this->setIfExists('producten', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['producten'];
    }

    /**
     * Sets producten
     *
     * @param int|null $producten producten
     *
     * @return self
     */
    public function setProducten($producten)
    {
        if (is_null($producten)) {
            throw new \InvalidArgumentException('non-nullable producten cannot be null');
        }
        $this->container['producten'] = $producten;
