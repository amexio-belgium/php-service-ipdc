 ...
 */
class UpsertAdres implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertAdres';
    ...
    protected static $openAPITypes = [
        'land' => '\OpenAPI\Client\Model\InputVertalingen',
        'huisnummer' => 'string',
        'busnummer' => 'string',
        'postcode' => 'string',
        'gemeentenaam' => '\OpenAPI\Client\Model\InputVertalingen',
        'straatnaam' => '\OpenAPI\Client\Model\InputVertalingen'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('busnummer', $data ?? [], null);
    ...
    */
     ...
     * Sets land
     *
     * @param \OpenAPI\Client\Model\InputVertalingen|null $land land
     *
     * @return self
     */
     ...
     * Sets huisnummer
     *
     * @param string|null $huisnummer huisnummer
     *
     * @return self
     */
    ...
    {
        return $this->container['busnummer'];
    }

    /**
     * Sets busnummer
     *
     * @param string|null $busnummer busnummer
     *
     * @return self
     */
    public function setBusnummer($busnummer)
    {
        if (is_null($busnummer)) {
            throw new \InvalidArgumentException('non-nullable busnummer cannot be null');
        }
        $this->container['busnummer'] = $busnummer;
     ...
     * Sets gemeentenaam
     *
     * @param \OpenAPI\Client\Model\InputVertalingen|null $gemeentenaam gemeentenaam
     *
     * @return self
     */
     ...
     * Sets straatnaam
     *
     * @param \OpenAPI\Client\Model\InputVertalingen|null $straatnaam straatnaam
     *
     * @return self
     */
